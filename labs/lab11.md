> Celem ćwiczeń jest zidentyfikowanie potencjalnych genów i elementów powtarzalnych we fragmecie genomowej sekwencji człowieka: [files/genomic.fasta](../files/genomic.fasta)
